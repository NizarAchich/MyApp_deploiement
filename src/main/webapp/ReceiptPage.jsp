...
<div class="row" id="ReceiptContent">
    <div class="row">
    ...
    <div class="row d-flex flex-row justify-content-between">
        <div class="col-2 d-flex flex-column">
            ...
            <div class="row"><span class="fs-6 fw-semibold">Email: <a href="mailto:"
                                                                      +${receipt.fournisseur.email}>${receipt.fournisseur.email}</a> </span>
            </div>
        ...
        <div class="col-2 d-flex flex-column">
            ...
            <div class="row"><span class="fs-6 fw-semibold">Email: <a href="mailto:"
                                                                      + ${receipt.client.email}>${receipt.client.email}</a></span>
            </div>
    ...
    <div class="row">
        <table class="table table-sm table-striped">
            ...
            <tr>
                ...
                <td><%=produit.getQuantite()%>
                </td>
                <td class="text-end w-50"><%=produit.getPrix()%>
                </td>
            </tr>
            <%
                }
...
<div class="row">
    ...
    <button class="btn btn-primary my-1" onclick="window.location.href='index.jsp'">Retour au formulaire</button>
</div>
</body>
